...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
    ...
    <div class="sidebar-brand-text mx-3">Sportify<sup></sup></div>
</a>
...
<li class="nav-item active">
    <a class="nav-link" href="dashboard-pengelola">
...
<li class="nav-item active">
    <a class="nav-link" href="table-lapangan">
...
<li class="nav-item active">
    <a class="nav-link" href="table-datatransaksi">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-0 text-gray-800">Dashboard Pengelola Lapangan</h1>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary">Chart Penyewaan Perbulan</h6>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Futsal
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Basket
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Badmintoon
                                        </span>
                                    </div>
                                </div>
                            </div>
